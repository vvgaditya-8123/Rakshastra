# Rakshastra Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.rakshastra/plugins/rakshastra-achievements/state.json` (existing unlock state)
  - `~/.rakshastra/plugins/rakshastra-achievements/scan_snapshot.json` (new)
  - `~/.rakshastra/plugins/rakshastra-achievements/scan_checkpoint.json` (new)
