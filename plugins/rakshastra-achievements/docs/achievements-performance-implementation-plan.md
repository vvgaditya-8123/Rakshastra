# Rakshastra Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.rakshastra/plugins/rakshastra-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.rakshastra/plugins/rakshastra-achievements/scan_checkpoint.json`.
