# Rakshastra Achievements Performance Spec (Post-Hackathon)

Status: Draft (no code changes yet)
Owner: rakshastra-achievements plugin
...
### `GET /api/plugins/rakshastra-achievements/achievements`
...
### `POST /api/plugins/rakshastra-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/rakshastra-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/rakshastra-achievements/overview`
...
- Persist plugin data under:
  - `~/.rakshastra/plugins/rakshastra-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.rakshastra/plugins/rakshastra-achievements/scan_checkpoint.json`
...
- `~/.rakshastra/plugins/rakshastra-achievements/`
