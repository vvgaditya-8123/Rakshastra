...
``_check_spotify_available()`` — when the user has not run ``rakshastra auth
spotify``, the tools remain registered (so they appear in ``rakshastra
...
The Spotify auth flow (``rakshastra auth spotify``), CLI plumbing, and docs
