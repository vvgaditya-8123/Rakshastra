...
// `message.content.text` before Rakshastra can see it. We rewrite the two inbound
...
const MARKER = "Rakshastra patch: Preserve mixed text + attachment iMessage payloads";
