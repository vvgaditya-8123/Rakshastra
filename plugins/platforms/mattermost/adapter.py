...
required — uses aiohttp which is already a Rakshastra dependency.
...
def interactive_setup() -> None:
    ...
    ``rakshastra_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Rakshastra delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # rakshastra_cli/setup.py::_setup_mattermost function.
