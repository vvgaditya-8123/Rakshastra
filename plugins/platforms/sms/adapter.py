...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Rakshastra gateway adapter.

    Each inbound phone number gets its own Rakshastra session (multi-tenant).
...
# static dict in rakshastra_cli/gateway.py, and the _send_sms dispatch in
