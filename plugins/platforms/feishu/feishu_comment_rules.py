...
Config: ~/.rakshastra/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.rakshastra/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_rakshastra_home()`` helper (RAKSHASTRA_HOME-aware and
...
RULES_FILE = get_rakshastra_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_rakshastra_home() / "feishu_comment_pairing.json"
