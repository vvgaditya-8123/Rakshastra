...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # through Rakshastra's agent loop.
        #
        ...
        # that would silently route around Rakshastra's web-provider config and
        ...
        # native search engine for xAI sessions instead of Rakshastra's
        # configured web provider (Tavily/etc.), and those results bypass
        # Rakshastra's tool-trace / citation plumbing (they arrive baked into the
