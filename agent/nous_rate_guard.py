...
(3 SDK retries x 3 Rakshastra retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_rakshastra_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".rakshastra")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Rakshastra, ...) behind one endpoint.  A 429 can mean either:
