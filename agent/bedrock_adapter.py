"""AWS Bedrock Converse API adapter for Rakshastra Agent.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Rakshastra with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When Rakshastra is installed editable into system Python, the system boto3
