"""
Cron job scheduling system for Rakshastra Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    rakshastra gateway install    # Install as a user service
    sudo rakshastra gateway install --system  # Linux servers: boot-time system service
    rakshastra gateway            # Or run in foreground
