...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      rakshastraNpmLib = self'.packages.default.passthru.rakshastraNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. rakshastra-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Rakshastra Agent dev shell"
          ${combinedNonNpm}
          ${rakshastraNpmLib.mkNpmDevShellHook npmPackageJsonPaths}
          echo "Ready. Run 'rakshastra' to start."
        '';
      };
    };
}
