#!/usr/bin/env python3
"""Build the Rakshastra Skills Index — a centralized JSON catalog of all skills.
...
`rakshastra skills search/install` can use it without hitting the GitHub API.
...
# Ensure RAKSHASTRA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Rakshastra Skills Index...", flush=True)
