...
DEFAULT_DATASETS = [
    ...
    "NousResearch/rakshastra-agent-megascience-sft1",
    "NousResearch/Rakshastra-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Rakshastra-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-rakshastra-agent"
]
