...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Rakshastra\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "rakshastra@nousresearch.com",
    "rakshastra-audit@example.com",
    "rakshastra@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/rakshastra-agent",
                "--state", "merged",
