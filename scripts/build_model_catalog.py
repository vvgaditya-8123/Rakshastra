#!/usr/bin/env python3
"""Build the Rakshastra Model Catalog — a centralized JSON manifest of curated models.
...
Rakshastra CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Rakshastra release.
...
# Ensure RAKSHASTRA_HOME is set for imports that touch it at module level.
os.environ.setdefault("RAKSHASTRA_HOME", os.path.join(os.path.expanduser("~"), ".rakshastra"))

from rakshastra_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "rakshastra-agent repo",
            "docs": "https://rakshastra-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
