...
```python
import sys
sys.path.insert(0, "/home/teknium/.rakshastra/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.rakshastra/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Rakshastra installs package this)
