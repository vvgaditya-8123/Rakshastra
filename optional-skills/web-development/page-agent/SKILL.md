...
- User wants **Rakshastra itself to drive a browser** → use Rakshastra' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
