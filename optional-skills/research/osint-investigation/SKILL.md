...
author: Rakshastra Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  rakshastra:
...
# $RAKSHASTRA_OSINT_CACHE/icij/ (default: ~/.cache/rakshastra-osint/icij/).
...
# Set RAKSHASTRA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
