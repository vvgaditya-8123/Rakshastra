...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Rakshastra Agent
license: MIT
...
The script reads `${RAKSHASTRA_HOME:-~/.rakshastra}/.env` for two optional defaults:
...
Helper script: `~/.rakshastra/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.rakshastra/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${RAKSHASTRA_HOME:-~/.rakshastra}/.env`.
...
```bash
python3 ~/.rakshastra/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.rakshastra/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
