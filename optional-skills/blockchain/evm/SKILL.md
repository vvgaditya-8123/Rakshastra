...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Rakshastra Agent
license: MIT
...
Helper script path: `~/.rakshastra/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.rakshastra/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.rakshastra/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.rakshastra/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
