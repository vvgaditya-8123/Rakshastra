...
4. Name the token (e.g., "Rakshastra Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${RAKSHASTRA_HOME:-~/.rakshastra}/.env`:
...
```bash
CANVAS="python $RAKSHASTRA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
