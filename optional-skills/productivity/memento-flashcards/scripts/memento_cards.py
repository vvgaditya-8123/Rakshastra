...
Data file: $RAKSHASTRA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_RAKSHASTRA_HOME = Path(os.environ.get("RAKSHASTRA_HOME", Path.home() / ".rakshastra"))
DATA_DIR = _RAKSHASTRA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
