...
version: 0.1.0
author: Mibay (Mibayy), Rakshastra Agent
license: MIT
...
```
SCRIPT=~/.rakshastra/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.rakshastra/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
