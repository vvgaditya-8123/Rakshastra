...
def worker_loop(worker_id: int, rakshastra_home: str, result_file: str) -> None:
...
def reclaimer_loop(rakshastra_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="rakshastra_mixed_stress_")
    print(f"RAKSHASTRA_HOME = {home}")
