...
part of the bundled-plugins set; a stock rakshastra-agent install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/rakshastra_cli/test_web_server.py`` copies this directory
into ``$RAKSHASTRA_HOME/plugins/example-dashboard/`` and forces the dashboard
