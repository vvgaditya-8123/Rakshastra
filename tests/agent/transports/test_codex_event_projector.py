"""Tests for CodexEventProjector — codex item/* events → Rakshastra messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Rakshastra' message alternation invariant."""
