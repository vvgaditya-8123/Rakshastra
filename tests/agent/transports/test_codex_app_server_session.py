...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_rakshastra_tools_auto_accepts(self):
        """When codex elicits on behalf of rakshastra-tools (our own callback),
