...
thinking phase.  Rakshastra's default cloud-stream stale detector
(``RAKSHASTRA_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``RAKSHASTRA_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
