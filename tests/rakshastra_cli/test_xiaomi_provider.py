...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from rakshastra_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in RAKSHASTRA_OVERLAYS
        overlay = RAKSHASTRA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify rakshastra doctor recognizes Xiaomi env vars."""
