"""Tests for the ``rakshastra prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from rakshastra_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(rakshastra_home, memory_text="", user_text=""):
    mem_dir = rakshastra_home / "memories"
...
def _seed_skill(rakshastra_home, name, description):
    skill_dir = rakshastra_home / "skills" / "demo" / name
