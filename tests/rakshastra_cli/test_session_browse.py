"""Tests for the interactive session browser (`rakshastra sessions browse`).
...
from rakshastra_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """rakshastra sessions browse should be parseable."""
