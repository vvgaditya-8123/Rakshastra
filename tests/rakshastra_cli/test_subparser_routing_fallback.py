...
The main() function in rakshastra_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `rakshastra -c model`
...
def _build_parser():
    """Build a minimal replica of the rakshastra top-level parser."""
