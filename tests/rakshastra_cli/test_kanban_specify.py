"""Tests for the specifier module + `rakshastra kanban specify` CLI surface.
...
from rakshastra_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `rakshastra kanban …` argparse surface directly."""
