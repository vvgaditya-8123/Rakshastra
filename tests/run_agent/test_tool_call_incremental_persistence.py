...
def _make_agent():
    rakshastra_home = Path(tempfile.mkdtemp(prefix="rakshastra-test-home-"))
    (rakshastra_home / "logs").mkdir(parents=True, exist_ok=True)
    with (
        patch(
        ...
        patch("run_agent._rakshastra_home", rakshastra_home),
