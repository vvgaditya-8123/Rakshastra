...
old_session_id=<old>). This lets plugin engines (e.g. rakshastra-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See rakshastra-lcm#68: after Rakshastra compresses and mints a new physical session,
