...
The unit tests in tests/rakshastra_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned rakshastra-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/rakshastra")
from rakshastra_cli.service_manager import S6ServiceManager
