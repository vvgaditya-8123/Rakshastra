...
def store(tmp_path, monkeypatch):
    ...
    ~/.rakshastra/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at rakshastra_state import time, before pytest's RAKSHASTRA_HOME monkeypatch
    fires — the autouse fixture's RAKSHASTRA_HOME override doesn't help here.)
    """
