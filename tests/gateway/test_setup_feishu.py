"""Tests for _setup_feishu() in rakshastra_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("rakshastra_cli.config.save_env_value", side_effect=mock_save), \
         patch("rakshastra_cli.config.get_env_value", side_effect=mock_get), \
         patch("rakshastra_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("rakshastra_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("rakshastra_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("rakshastra_cli.cli_output.print_header"), \
         patch("rakshastra_cli.cli_output.print_info"), \
         patch("rakshastra_cli.cli_output.print_success"), \
         patch("rakshastra_cli.cli_output.print_warning"), \
         patch("rakshastra_cli.cli_output.print_error"), \
