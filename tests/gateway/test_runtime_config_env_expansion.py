...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("RAKSHASTRA_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("RAKSHASTRA_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("RAKSHASTRA_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
