 ...
 * `window.__RAKSHASTRA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Rakshastra brand in the top bar
 ...
 *  `window.__RAKSHASTRA_PLUGINS__.registerSlot(...)`.
 *
