/**
 * Rakshastra Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__RAKSHASTRA_PLUGIN_SDK__`` and
 * ``window.__RAKSHASTRA_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__RAKSHASTRA_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``RakshastraPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@rakshastra/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__RAKSHASTRA_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__RAKSHASTRA_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__RAKSHASTRA_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface RakshastraPluginSDK {
...
declare global {
  interface Window {
    __RAKSHASTRA_PLUGIN_SDK__?: RakshastraPluginSDK;
    __RAKSHASTRA_PLUGINS__?: PluginRegistry;
  }
}
