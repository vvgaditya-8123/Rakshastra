 ...
 *
 * Plugins call window.__RAKSHASTRA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__RAKSHASTRA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__RAKSHASTRA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__RAKSHASTRA_PLUGIN_SDK__ = {
    ...
    // window.__RAKSHASTRA_SESSION_TOKEN__ directly.
    authedFetch,
