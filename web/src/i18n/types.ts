...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateRakshastra: string;
    updateRakshastraConfirmMessage?: string;
    updateRakshastraConfirmNow?: string;
    updateRakshastraConfirmTitle?: string;
    updatingRakshastra: string;
  ...
  // ── Achievements plugin (plugins/rakshastra-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
