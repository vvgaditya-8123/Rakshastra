...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateRakshastra: "Update Rakshastra",
    updateRakshastraConfirmMessage:
      "This runs rakshastra update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateRakshastraConfirmNow: "Update now",
    updateRakshastraConfirmTitle: "Update Rakshastra?",
    updatingRakshastra: "Updating Rakshastra…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Rakshastra plugins (`rakshastra plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.rakshastra/plugins/?",
    removeHint: "Only user-installed plugins under ~/.rakshastra/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.rakshastra/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Rakshastra doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Rakshastra badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Rakshastra session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Rakshastra more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Rakshastra sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Rakshastra is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
