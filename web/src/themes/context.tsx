...
const STORAGE_KEY = "rakshastra-dashboard-theme";
...
const FONT_STORAGE_KEY = "rakshastra-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `rakshastra_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "rakshastra-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-rakshastra-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-rakshastra-theme-font", "true");
