 ...
 *
 * Values mirror rakshastra_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Rakshastra default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Rakshastra' default when unset). */
