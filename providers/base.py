...
def _profile_user_agent() -> str:
    """Return a ``rakshastra-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from rakshastra_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"rakshastra-cli/{_ver}"
    except Exception:
        return "rakshastra-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # rakshastra-cli UA so the catalog endpoint is reachable.
