#!/usr/bin/env python3
"""
SWE Runner with Rakshastra Trajectory Format

A runner that uses Rakshastra-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Rakshastra-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Rakshastra-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Rakshastra format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Rakshastra-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Rakshastra-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Rakshastra Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Rakshastra-Agent's built-in execution environments
    and outputs trajectories in Rakshastra-Agent format.
    """
    ...
    def _convert_to_rakshastra_format(
        self,
        ...
        """
        Convert internal message format to Rakshastra trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Rakshastra trajectory format
        trajectory = self._convert_to_rakshastra_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Rakshastra trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Rakshastra Trajectory Format")
    print("=" * 60)
