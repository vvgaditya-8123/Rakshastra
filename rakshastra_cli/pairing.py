...
Usage:
    rakshastra pairing list              # Show all pending + approved users
    rakshastra pairing approve <platform> <code>  # Approve a pairing code
    rakshastra pairing revoke <platform> <user_id> # Revoke user access
    rakshastra pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle rakshastra pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: rakshastra pairing {list|approve|revoke|clear-pending}")
        print("Run 'rakshastra pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.rakshastra/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'rakshastra pairing list' to see pending codes.\n")
