"""
Rakshastra CLI - Unified command-line interface for Rakshastra Agent.

Provides subcommands for:
- rakshastra chat          - Interactive chat (same as ./rakshastra)
- rakshastra gateway       - Run gateway in foreground
- rakshastra gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `rakshastra setup` on a fresh Pi.
    ...
    rakshastra_cli/stdio.py::configure_windows_stdio() runs later from the entry
