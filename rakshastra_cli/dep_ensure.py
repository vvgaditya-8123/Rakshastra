...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_rakshastra_agent_browser()
    ),
...
def _has_rakshastra_agent_browser() -> bool:
    ...
    # install.sh installs globally into $RAKSHASTRA_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-RakshastraHome", str(get_rakshastra_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = rakshastra_subprocess_env(inherit_credentials=False)
