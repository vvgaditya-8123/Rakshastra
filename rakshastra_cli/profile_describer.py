...
Used by ``rakshastra profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``rakshastra_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Rakshastra Agent kanban board.
...
Rules:
  ...
  - Never write "Rakshastra Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_rakshastra_home())
        else:
