...
Visual styling mirrors the Rakshastra design system (the
...
``tests/rakshastra_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Rakshastra Agent</title>
<style>
...
<body>
<main>
  <div class="brand">Rakshastra<span class="dot"></span>Defense</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Rakshastra Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Rakshastra Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
