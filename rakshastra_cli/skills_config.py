"""
Skills configuration for Rakshastra Agent.
`rakshastra skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.rakshastra/config.yaml under:
...
from rakshastra_cli.config import cfg_get, load_config, save_config
from rakshastra_cli.colors import Colors, color
from rakshastra_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `rakshastra skills`."""
    from rakshastra_cli.curses_ui import curses_checklist
