"""``rakshastra tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'rakshastra tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # rakshastra tools list [--platform cli]
    ...
    # rakshastra tools disable <name...> [--platform cli]
    ...
    # rakshastra tools enable <name...> [--platform cli]
    ...
    # rakshastra tools post-setup <key>
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `rakshastra tools` runs after you pick a provider that\n"
