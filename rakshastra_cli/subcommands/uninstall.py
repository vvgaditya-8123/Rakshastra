"""``rakshastra uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Rakshastra Agent",
        description="Remove Rakshastra Agent from your system. Can keep configs/data for reinstall.",
    )
