"""Client for uploading ``rakshastra debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``rakshastra debug share``.
...
NAS_BASE = os.environ.get(
    "RAKSHASTRA_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "rakshastra-agent/debug-share"
