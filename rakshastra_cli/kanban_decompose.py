...
Invoked by ``rakshastra kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Rakshastra Agent board.
...
def _profile_author() -> str:
    """Mirror of ``rakshastra_cli.kanban._profile_author``."""
    return (
