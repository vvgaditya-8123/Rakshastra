...
version: 4.0.0
author: 0xbyt4, Rakshastra Agent
license: MIT
dependencies: []
...
```bash
python3 -m pyfiglet "RAKSHASTRA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=RAKSHASTRA&font=Slant" | boxes -d stone
```
