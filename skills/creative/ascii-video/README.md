...
Built for [Rakshastra Agent](https://github.com/NousResearch/rakshastra-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/rakshastra-agent/skills/creative/ascii-video`](https://github.com/NousResearch/rakshastra-agent/tree/main/skills/creative/ascii-video) via PR.
