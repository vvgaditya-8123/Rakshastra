...
try:
    ...
    _RAKSHASTRA_VERSION = "0.0.0"

_APP_VERSION = _RAKSHASTRA_VERSION
_BOT_VERSION = _RAKSHASTRA_VERSION
_YUANBAO_INSTANCE_ID = str(RAKSHASTRA_INSTANCE_ID)  # single source: yuanbao_proto.RAKSHASTRA_INSTANCE_ID
