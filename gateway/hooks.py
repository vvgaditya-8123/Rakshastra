...
Hooks are discovered from ~/.rakshastra/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Rakshastra session id
...
HOOKS_DIR = get_rakshastra_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"rakshastra_hook_{hook_name}"
