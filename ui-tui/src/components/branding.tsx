import { Box, Text, useStdout } from '@rakshastra/ink'
...
const TAG_FULL = 'Rakshastra · Digital Defense and Security Operations'
const TAG_MID = 'Digital Defense and Security Operations'
const TAG_TINY = 'Rakshastra'
const HIDE_BELOW = 34
...
export function SessionPanel({ info, maxWidth, sid, t }: SessionPanelProps) {
  ...
  // rakshastra_cli/banner.py) and the "connected" label on the collapse toggle.
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Rakshastra</Text>
          </Text>
      ...
      <Box flexDirection="column" width={w}>
        ...
        {typeof info.update_behind === 'number' && info.update_behind > 0 && (
          <Text bold color={t.color.warn}>
            ...
            <Text bold color={t.color.warn}>
              {info.update_command || 'rakshastra update'}
            </Text>
            <Text bold={false} color={t.color.warn} dimColor>
              {' '}
              to update
