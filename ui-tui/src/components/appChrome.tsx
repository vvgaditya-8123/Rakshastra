import { Box, type ScrollBoxHandle, stringWidth, Text } from '@rakshastra/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (RAKSHASTRA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (RAKSHASTRA_DEV_CREDITS), lowest priority,
