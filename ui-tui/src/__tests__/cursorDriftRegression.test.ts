 ...
 *
 * Symptom: in `rakshastra --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@rakshastra/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using rakshastra --tui and as i type multiline my caret at the end will often ' +
