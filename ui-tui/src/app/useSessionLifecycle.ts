...
import type { ScrollBoxHandle } from '@rakshastra/ink'
import { evictInkCaches } from '@rakshastra/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.RAKSHASTRA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
