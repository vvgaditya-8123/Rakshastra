...
await build({
  ...
  // Skip the prebuilt @rakshastra/ink bundle and inline the source instead:
  ...
  alias: { '@rakshastra/ink': resolve(root, 'packages/rakshastra-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The rakshastra_cli launcher
