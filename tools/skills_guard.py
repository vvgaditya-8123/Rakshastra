...
Trust levels:
  - builtin:   Ships with Rakshastra. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.rakshastra/\.env|\~/\.rakshastra/\.env',
     "rakshastra_env_access", "critical", "exfiltration",
     "directly references Rakshastra secrets file"),
    ...
    (r'\.rakshastra/config\.yaml|\.rakshastra/SOUL\.md',
     "rakshastra_config_mod", "critical", "persistence",
     "references Rakshastra configuration files directly"),
...
# scan. `.skillignore` is the Rakshastra-native name; `.clawhubignore` is honored
