...
def auth_json_path():
    """Return the Rakshastra auth store path, respecting RAKSHASTRA_HOME overrides."""
    return get_rakshastra_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`rakshastra tools`, banner/status paint, provider
